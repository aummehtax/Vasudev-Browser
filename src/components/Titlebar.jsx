  ...
  return (
    <div className="titlebar" style={style}>
      ...
      <div className="actions">
        ...
        <button className="icon" onClick={onMetrics} title="System Usage" aria-label="System Usage">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 19h16" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
            <rect x="6" y="11" width="3" height="6" rx="1" stroke="currentColor" strokeWidth="2"/>
            <rect x="11" y="7" width="3" height="10" rx="1" stroke="currentColor" strokeWidth="2"/>
            <rect x="16" y="9" width="3" height="8" rx="1" stroke="currentColor" strokeWidth="2"/>
          </svg>
        </button>
